...
var DefaultViewBuilderCore, ViewBuilder2, ManualViewBuilder2, MaterializedViewBuilderCore, MaterializedViewBuilder, ManualMaterializedViewBuilder, PgView, PgMaterializedViewConfig, PgMaterializedView;
var init_view2 = __esm({
  "node_modules/drizzle-orm/pg-core/view.js"() {
    ...
    ViewBuilder2 = class extends DefaultViewBuilderCore {
    ...
    ManualViewBuilder2 = class extends DefaultViewBuilderCore {
...
var db_cloudflare_exports = {};
__export(db_cloudflare_exports, {
  CloudflareSessionService: () => CloudflareSessionService,
  createD1DB: () => createD1DB,
  createDB: () => createDB,
  createPostgreSQLDB: () => createPostgreSQLDB,
  getCookie: () => getCookie,
  setCookie: () => setCookie
});
...
var CloudflareSessionService;
var init_db_cloudflare = __esm({
  "server/db-cloudflare.ts"() {
    "use strict";
    init_d1();
    ...
    init_serverless();
    init_schema2();
    CloudflareSessionService = class {
      kv;
      constructor(env) {
        if (!env.KV) {
...
async function onRequestGet(context) {
  try {
    ...
    try {
      const { createDB: createDB2 } = await Promise.resolve().then(() => (init_db_cloudflare(), db_cloudflare_exports));
      const db = createDB2(context.env);
      await db.select().from(await Promise.resolve().then(() => (init_schema2(), schema_exports)).then((s) => s.leads)).limit(1);
      dbStatus = "healthy";
    } catch (error) {
      dbStatus = "error";
